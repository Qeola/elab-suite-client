     ...
     <div style={{display:'flex',flexDirection:'column',flexWrap:'nowrap',alignItems:'center', justifyContent:'center',minHeight:'100vh'}} >
       ...
       <Box sx={{ textAlign:'center'}}>
        ...
        <Typography sx={{maxWidth:'60ch'}} component={'p'} >
          Welcome aboard!. Your account has now been verified successfully. You would be automatically redirected shortly. If not redirected, click the button below.
        </Typography>
       </Box>
        <Typography component={Link} href='/dashboard' sx={{ color:'black',backgroundColor:'#FFCC03',fontWeight:600,paddingBlock:'.7rem',paddingInline:'3rem',borderRadius:'3px', marginTop:'1rem'}}>
